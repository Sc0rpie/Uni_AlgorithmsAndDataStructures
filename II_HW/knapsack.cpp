...
int main()
{
    ...
    outShort << "Olen Rackauskas, 1 kursas, 3 grupe, 2 pogrupis, 2 uzduotis, 3 variantas" << endl
        << endl;
    outFull << "Olen Rackauskas, 1 kursas, 3 grupe, 2 pogrupis, 2 uzduotis, 3 variantas" << endl
        << endl;
    ...
    outShort << "Uzduoties aprasas: Duota N daiktu, kuriu svoriai s1, s2, ... sN, o kainos k1, k2, ... kN. Programa turi sudaryti daiktu rinkini, kurio kaina butu maksimali, o svoris nevirsytu nurodyto svorio S. Vartotojas nurodo faila, is kurio programa iveda daiktu svorius ir kainas, bei svori S." << endl
        << endl;
    outFull << "Uzduoties aprasas: Duota N daiktu, kuriu svoriai s1, s2, ... sN, o kainos k1, k2, ... kN. Programa turi sudaryti daiktu rinkini, kurio kaina butu maksimali, o svoris nevirsytu nurodyto svorio S. Vartotojas nurodo faila, is kurio programa iveda daiktu svorius ir kainas, bei svori S." << endl
        << endl;

    cout << "Ivesties failas: " << filename << endl
        << endl;
    outShort << "Ivesties failas: " << filename << endl
        << endl;
    outFull << "Ivesties failas: " << filename << endl;
    ...
    // cout << "II DALIS:" << endl;
    outFull << "II DALIS: Vykdymas" << endl;
    ...
    outFull << endl << "III DALIS: Rezultatas" << endl;
    ...
    if(itemCount > 0)
    {
        cout << "Daiktu sarasas rastas. Bandymu skaicius: " << steps - 1 << endl;
        outShort << "Daiktu sarasas rastas. Bandymu skaicius: " << steps - 1 << endl;
        outFull << "Daiktu sarasas rastas. Bandymu skaicius: " << steps - 1 << endl;
    ...
    {
        cout << "Daiktu sarasas nerastas. Bandymu skaicius: " << steps - 1 << endl << "Nera daiktu, kurie turetu svori mazesni nei " << S << endl;
        outShort << "Daiktu sarasas nerastas. Bandymu skaicius: " << steps - 1 << endl << "Nera daiktu, kurie turetu svori mazesni nei " << S << endl;
        outFull << "Daiktu sarasas nerastas. Bandymu skaicius: " << steps - 1 << endl << "Nera daiktu, kurie turetu svori mazesni nei " << S << endl;
    }
