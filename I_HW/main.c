...
void menu()
{
    ...
    while (showMenu)
    {
        ...
        printf("[4] Prideti elementa i deko pradzia\n");  // Push to front (Prideti elementa i deka)
        printf("[5] Prideti elementa i deko pabaiga\n");  // Push to back
        printf("[6] Isimti elementa is deko pradzios\n"); // Pop from front (isimtas elementas su reiksme)
        printf("[7] Isimti elementa is deko pabaigos\n"); // Pop from back
        printf("[8] Atspausdinti deka\n");                // Print deck (atspausdinti deka) (pradzia ... pabaiga)
        ...
        case 2:
            ...
            if (idToCheck == -2)
                ...
                printf("Klaida #2 - Nera prieinamu deku\n");
            else if (idToCheck != -1)
            {
        ...
        case 9:
            ...
            else if (idToCheck != -1)
            {
                ...
                printf("Dekas su ID %d buvo istrintas\n", idToCheck+1); // Deck with id %d has been removed!
            }
            else
            {
                // printf("Toks ID neegzistuoja.\n"); //Incorrect ID
